			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 signup-header">
						...
						<h2 class="wow fadeInLeft">You have entered the Duplicated Data.</h2>
							<h3>Please be ensured that these field below is not duplicated with another...</h3>
							<br/>
							<ul>
								<li>Room's Code or Room's Name (On Room Editing or Creating)</li>
								<li>Facility's Name (On Facility's Editing or Creating)</li>
							</ul>
						<br/>
